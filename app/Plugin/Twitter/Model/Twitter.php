<?php
    ...
    class Twitter extends AppModel {
        ...
        function post($endpoint="statuses/update", $parameters = array('status'=>'Dans twitter plugin is awesome'), $isUpload = false) {
            return $this->get_token_connection()->post($endpoint, $parameters, $isUpload);
        }

        //TODO: ADD Description
        public function postTweet($status){
            $twitter = $this->post('statuses/update',array('status'=>$status));
        }
    }