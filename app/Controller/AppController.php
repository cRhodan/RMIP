 ...
 * @var array
 */
	public $components = array('Cookie', 'Session', 'Auth' => array('authorize' => 'Controller'), 'RequestHandler');
 ...
 */
	public function beforeFilter() {
		...
		// Set the userRole variable to indicate if the user is an admin (userRole = 1) or a basic user (userRole = 2)
		// A result of 0 indicates the user is not logged in
