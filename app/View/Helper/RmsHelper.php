 ...
 * @return string The HTML for the entire script block.
 * Modification: for height and width.
 */
	public function ros2d($background = '#111111',$heightScale=1.9925) {
        ...
        $html .= __(
            '{divID:"viewer2d",width:w,height:h,antialias:true,background:"%s"});', $heightScale, $background
        );


        /**
        $html .= __(
			'{divID:"viewer2d",width:w,height:w*1.9925,antialias:true,background:"%s"});', $heightScale, $background
		);
        */
