		...
		<section>
			<div class="row">
                ...
                <section class="<?php echo $u; ?>">
                    <a href="#howtotutorial" class="button special scrolly">How to tutorial</a>
                </section>
				<!-- <section class="<?php echo $u; ?>">
            ...
            <div class="row">
                <section class="<?php echo $u; ?>">
                    <a href="#available" class="button special scrolly">How to tutorial</a>
                </section>
            </div>
            -->
		</section>
...
<hr />
<section id="howtotutorial" class="wrapper style4 container">
    <div class="content left">
        <section>
            <header>
                <h2>How to use this page</h2>
                <p>This tutorial will guide you how to use this page.</p>
                <p>Clicking the "Interfaces" button above scrolls you to see available environments.
                    <a href="http://wiki.ros.org/rms/Tutorials/AGuideToInterfaceDevelopment" target="_blank">Environments</a>
                    consist of rosbridge, MJPEG servers and an interface linked to. Interface is
                an actual implementation of <a href="http://en.wikipedia.org/wiki/Model-view-controller" target="_blank">
                Model-view-controller</a> software architecture pattern.</p>
                <p>Check the status of rosbridge and MJPEG servers are all GREEN thumbs-up.
                    Otherwise image stream and map won't be visualized.</p>
                <p>You then will see the following page by clicking an environment name.</p>
                <h7><img src="http://drive.google.com/uc?export=view&id=0B95cfyh_pgRwS1FrNEp4cU8wOWM"></h7>
                <p>The top image displays streaming image from the Guiabot. The bottom image visualizes 2D map with the current robot pose (blue triangle) and the goal (red triangle).
                It might take some time for loading depends on your network connection.</p>
                <p><strong>/cmd_vel</strong> ros Twist Message shows velocity commands sent to the robot. (Translation(m/s) and rotation (rad/s) in quaternion representation)</p>
            </header>
        </section>
    </div>
</section>
